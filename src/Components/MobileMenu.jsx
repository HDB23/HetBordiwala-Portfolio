...
export const MobileMenu = ({menuOpen, setMenuOpen}) => {
  ...
  return (
    ...
    >
        ...
        href="#home" 
        onClick={()=> setMenuOpen(false)}
        className={`text-2xl font-semibold text-white my-4 transform transition-transform duration-300 ${menuOpen ? "opacity-100 translate-y-0" : "opacity-0 transition-y-5"}`}
        >
            Home 
        </a>
        <a 
